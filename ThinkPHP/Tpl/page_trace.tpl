<div id="think_page_trace"
    ...
    <div id="think_page_trace_tab" style="display: none;background:white;margin:0;height: 500px;">
        ...
        <div id="think_page_trace_tab_cont" style="overflow:auto;height:424px;padding: 0; line-height: 24px">
            <?php
	...
	if(is_array($info)){
		foreach ($info as $k=>$val){
                    if($k=='CODING'){
                    echo '<script type="text/javascript" src="/Public/plug/syntaxhighlighter/scripts/shCore.js"></script>';
                    echo '<script type="text/javascript" src="/Public/plug/syntaxhighlighter/scripts/shBrushBash.js"></script>';
                    echo '<script type="text/javascript" src="/Public/plug/syntaxhighlighter/scripts/shBrushCSharp.js"></script>';
                    echo '<script type="text/javascript" src="/Public/plug/syntaxhighlighter/scripts/shBrushPhp.js"></script>';
                    echo '<link type="text/css" rel="stylesheet" href="/Public/plug/syntaxhighlighter/styles/shCore.css"/>';
                    echo '<link type="text/css" rel="stylesheet" href="/Public/plug/syntaxhighlighter/styles/shThemeDefault.css"/>';
                    echo '<script type="text/javascript">SyntaxHighlighter.config.clipboardSwf = "scripts/clipboard.swf";SyntaxHighlighter.all();</script>';
                    echo '<pre class="brush: c-sharp;">'.htmlentities($val,ENT_COMPAT,'utf-8').'</pre>';
                    }else{
                    echo '
